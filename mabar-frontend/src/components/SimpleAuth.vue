  ...
  <div class="min-h-screen bg-slate-50 flex items-center justify-center p-4">
    <div class="w-full max-w-md bg-white rounded-3xl shadow-xl border border-slate-200 overflow-hidden">
      ...
      <div class="p-8 text-center">
        ...
        <p class="text-slate-600 mb-6">This is a simplified version to test the app.</p>
        <button class="bg-emerald-500 hover:bg-emerald-600 text-white px-8 py-3 rounded-2xl transition-all duration-200 font-medium">
          Get Started
        </button>
      </div>
    </div>
